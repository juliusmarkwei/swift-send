...
urlpatterns = [
    ...
    path('message-logs/<int:messageId>/resend', views.ResendLogMessage.as_view(), name='resend-message'),
    path('message-logs/<int:messageId>/edit-resend', views.EditResendLogMessage.as_view(), name='edit-resend-message'),
