...
urlpatterns = [
    ...
    path('templates', views.TemplateListCreateUpdateDestroyView.as_view(), name='template-view'),
    path('templates/<int:templateId>', views.TemplateListCreateUpdateDestroyView.as_view(), name='template-detail'),
